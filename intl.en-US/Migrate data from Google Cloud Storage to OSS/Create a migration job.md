...
4.  On the Performance tab, navigate to the **Data Prediction**area and enter the **Data Size** and **File Count**.
    ...
    **Note:** To ensure a successful migration, you must estimate the amount of data to be migrated. For more information, see [Estimate the amount of data to be migrated](intl.en-US/Migrate data from Google Cloud Storage to OSS/Prerequisites.md#section_frm_3my_pfb).

...
|SourceAddrRegionInvalid|腾讯云源数据地址所属地区（Region）无效。|请填写正确的腾讯云数据地址所属地域。详情请参见[地域与简称对照表](地域与简称对照表../DNhcs_mgw1842487/ZH-CN_TP_40765_V15.dita#concept_aws_xzl_qfb/table_lvb_xs1_tfb)。|

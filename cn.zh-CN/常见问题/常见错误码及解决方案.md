...
|错误码|错误信息|处理方案|
|---|----|----|
|AzureSourceConnStrAccountInvalid|Azure连接字符串或者存储账户无效。|Azure的连接字符串填写错误或者存储账户存在问题，导致无法访问您填写的Azure容器，请使用正确的信息创建数据地址。Azure的连接字符串详情请参见[../DNhcs\_mgw1825807/ZH-CN\_TP\_40751\_V17.dita\#concept\_qt5\_x3l\_qfb/look](../DNhcs_mgw1825807/ZH-CN_TP_40751_V17.dita#concept_qt5_x3l_qfb/look)。|
